...
class MSFS2024_Tree(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Tree, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Tree.drawParametersPanel(layout, material)
        MSFS2024_Tree.drawTexturesPanel(layout, material)
