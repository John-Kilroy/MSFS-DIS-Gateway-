...
class MSFS2024_Ghost(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Ghost, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Ghost.drawParametersPanel(layout, material)
        MSFS2024_Ghost.drawTexturesPanel(layout, material)
    ...
    def drawParametersPanel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.ghostBias.attributeName()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.ghostPower.attributeName()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.ghostScale.attributeName()
        )
        #### End Ghost parameters ####
        return
