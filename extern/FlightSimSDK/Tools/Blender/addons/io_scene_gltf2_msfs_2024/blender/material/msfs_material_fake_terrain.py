...
class MSFS2024_Fake_Terrain(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Fake_Terrain, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Fake_Terrain.drawParametersPanel(layout, material)
        MSFS2024_Fake_Terrain.drawTexturesPanel(layout, material)
