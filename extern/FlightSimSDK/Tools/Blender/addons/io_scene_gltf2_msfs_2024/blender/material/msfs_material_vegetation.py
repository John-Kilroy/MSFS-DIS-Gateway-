...
class MSFS2024_Vegetation(MSFS2024_Material):
    ...
    attributes = [
        ...
        MSFS2024_MaterialProperties.foliageMaskTexture
    ]
    ...
    def customShaderTree(self):
        super(MSFS2024_Vegetation, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Vegetation.drawParametersPanel(layout, material)
        MSFS2024_Vegetation.drawTexturesPanel(layout, material)
    ...
    def drawTexturesPanel(layout, material):
        ...
        ## Foliage Mask Texture
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout = box, 
            material = material, 
            property = MSFS2024_MaterialProperties.foliageMaskTexture.attributeName(),
            text = MSFS2024_MaterialProperties.foliageMaskTexture.name()
        )
        return