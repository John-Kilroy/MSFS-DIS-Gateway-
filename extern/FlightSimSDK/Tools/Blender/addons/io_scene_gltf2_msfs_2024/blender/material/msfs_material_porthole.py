...
class MSFS2024_Porthole(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Porthole, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Porthole.drawParametersPanel(layout, material)
        MSFS2024_Porthole.drawTexturesPanel(layout, material)
