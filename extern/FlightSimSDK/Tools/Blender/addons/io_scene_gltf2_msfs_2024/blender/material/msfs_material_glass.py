...
class MSFS2024_Glass(MSFS2024_Material):
    ...
    attributes = [
        ...
        MSFS2024_MaterialProperties.glassWidth,
    ...
    def customShaderTree(self):
        super(MSFS2024_Glass, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Glass.drawParametersPanel(layout, material)
        MSFS2024_Glass.drawTexturesPanel(layout, material)
    ...
    def drawParametersPanel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.glassWidth.attributeName()
        )
        #### End Glass parameters ####
        return
