...
class MSFS2024_Propeller(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Propeller, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Propeller.drawParametersPanel(layout, material)
        MSFS2024_Propeller.drawTexturesPanel(layout, material)
