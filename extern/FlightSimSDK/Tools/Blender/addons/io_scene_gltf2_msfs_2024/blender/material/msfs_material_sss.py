...
class MSFS2024_SSS(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_SSS, self).defaultShadersTree()
    ...
    def setSSSColor(self, color):
        ...
        nodePrincipledBSDF.inputs[MSFS2024_PrincipledBSDFInputs.subsurfaceColor.value].default_value = color

    @staticmethod
    def drawPanel(layout, material):
        MSFS2024_SSS.drawParametersPanel(layout, material)
        MSFS2024_SSS.drawTexturesPanel(layout, material)
    ...
    def drawTexturesPanel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.opacityTexture.attributeName(),
            text = MSFS2024_MaterialProperties.opacityTexture.name()
        )
