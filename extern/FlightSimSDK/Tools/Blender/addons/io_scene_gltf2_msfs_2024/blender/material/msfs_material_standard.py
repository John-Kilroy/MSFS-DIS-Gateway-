...
class MSFS2024_Standard(MSFS2024_Material):
    ...
    def customShaderTree(self):
        super(MSFS2024_Standard, self).defaultShadersTree()
    ...
    def drawPanel(layout, material):
        MSFS2024_Standard.drawParametersPanel(layout, material)
        MSFS2024_Standard.drawTexturesPanel(layout, material)
    ...
    def drawParametersPanel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout = box,
            material = material,
            property = MSFS2024_MaterialProperties.usePearlEffect.attributeName()
        )
        ...
        if material.msfs_use_pearl:
            ...
            MSFS2024_MaterialUtilsUI.draw_prop(
                layout = box,
                material = material,
                property = MSFS2024_MaterialProperties.pearlColorShift.attributeName()
            )
            ...
            MSFS2024_MaterialUtilsUI.draw_prop(
                layout = box,
                material = material,
                property = MSFS2024_MaterialProperties.pearlColorRange.attributeName()
            )
            ...
            MSFS2024_MaterialUtilsUI.draw_prop(
                layout = box,
                material = material,
                property = MSFS2024_MaterialProperties.pearlColorBrightness.attributeName()
            )
        #### End Pearl parameters ####
        return
