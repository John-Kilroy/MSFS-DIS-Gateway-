...
class MSFS2024_MultiExporterSettings(bpy.types.PropertyGroup):
    ...
    ## Export Process
    reset_node_origin: bpy.props.BoolProperty(
        name = "Reset Node Origin", 
        description = "Reset translation and rotation of root nodes", 
        default = False
    )
    ...
    merge_nodes: bpy.props.BoolProperty(
        name = "Merge nodes ", 
        description = "Merge selected Meshs into one root mesh to export", 
        default = False
    )
    #endregion
    ...
    export_extras: bpy.props.BoolProperty(
        ...
        description="Export custom properties as glTF extras. Must be disabled for export dedicated to Microsoft Flight Simulator 2024",
        default=False,
    )
...
class MSFS2024_PT_MSFS2024_extension(bpy.types.Panel):
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_label = "Extensions"
...
def register():
    bpy.types.Scene.msfs_multi_exporter_settings = bpy.props.PointerProperty(type=MSFS2024_MultiExporterSettings)