...
class AsoboMaterialShadowOptionsExtension:
    ...
    ExtensionName = "ASOBO_material_shadow_options"

    class Defaults:
        noCastShadow = False

    bpy.types.Material.msfs_no_cast_shadow = bpy.props.BoolProperty(
        name = MSFS2024_MaterialProperties.noCastShadow.name(),
        default = MSFS2024_MaterialProperties.noCastShadow.defaultValue(),
        options = set()
    )
    ...
    def from_dict(blender_material, gltf2_material, import_settings):
        ...
        extension = extensions.get(AsoboMaterialShadowOptionsExtension.ExtensionName)
    ...
    def to_extension(blender_material, gltf2_material, export_settings):
        ...
        if result:
            gltf2_material.extensions[AsoboMaterialShadowOptionsExtension.ExtensionName] = Extension(
                name = AsoboMaterialShadowOptionsExtension.ExtensionName,
                extension = result,
                required = False,
            )
