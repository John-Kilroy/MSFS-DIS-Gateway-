...
class AsoboAdvancedLight:
    ...
    ExtensionName = "ASOBO_advanced_light"
    ...
    def create(vnode, gltf_node):
        ...
        extension = gltf_node.extensions.get(AsoboAdvancedLight.ExtensionName)
        if not extension:
            return

        bpy.ops.msfs2024.add_light(name = gltf_node.name, msfs_light_type="advancedLight")
        ...
        for extensionParameter in AsoboAdvancedLight.ExtensionParameters:
        ...
        if MSFS2024LightPropertiesEnum.lightShape.extensionName() and extension.get(MSFS2024LightPropertiesEnum.lightShape.extensionName()) is not None:
            ...
            for shapeType, index in AsoboAdvancedLight.ShapeTypeMatchTable.items():
    ...
    def removeLightObject(vnode, gltf2_node, blender_node):
        ...
        if gltf2_node.extensions:
            extension = gltf2_node.extensions.get(AsoboAdvancedLight.ExtensionName)
            if extension:
    ...
    def export(gltf2_object, blender_object):
        ...
        if getattr(blender_light, MSFS2024LightPropertiesEnum.lightType.attributeName()) != "advancedLight":
            return
        ...
        if MSFS2024LightPropertiesEnum.lightShape.extensionName():
            shapeTypeIndex = AsoboAdvancedLight.ShapeTypeMatchTable[getattr(msfs_light_properties, MSFS2024LightPropertiesEnum.lightShape.attributeName())]
        ...
        gltf2_object.extensions[AsoboAdvancedLight.ExtensionName] = Extension(
            name=AsoboAdvancedLight.ExtensionName,
            extension=extension,
            required=False
        )