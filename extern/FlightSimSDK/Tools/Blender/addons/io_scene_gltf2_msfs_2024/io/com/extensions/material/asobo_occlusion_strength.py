...
class AsoboOcclusionStrengthExtension:
    ...
    ExtensionName = "ASOBO_occlusion_strength"

    bpy.types.Material.msfs_occlusion_strength = bpy.props.FloatProperty(
        name = MSFS2024_MaterialProperties.occlusionStrength.name(),
        min = 0.0,
        max = 2.0,
        default = MSFS2024_MaterialProperties.occlusionStrength.defaultValue(),
        options = set(),
        precision = 3
    )
    ...
    def from_dict(blender_material, gltf2_material, import_settings):
        ...
        extension = extensions.get(AsoboOcclusionStrengthExtension.ExtensionName)
    ...
    def to_extension(blender_material, gltf2_material, export_settings):
        ...
        if result:
            gltf2_material.extensions[AsoboOcclusionStrengthExtension.ExtensionName] = Extension(
                name = AsoboOcclusionStrengthExtension.ExtensionName, 
                extension = result, 
                required = False
            )