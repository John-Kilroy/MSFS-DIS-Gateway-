...
#Note: this is deprecated to generate UI files as it uses PyQt's libraries and we're now using PySide2
# one may simply use "pyside2-uic file.ui -o file_ui.py" in terminal from folder...

dirPath = os.path.dirname(os.path.realpath(__file__))
uiCompiledDest = os.path.join(dirPath, r"ui")
rccCompileDest = os.path.join(dirPath, r"rcc")
