...
namespace BabylonExport.Entities
{
	...
	public class BabylonScene
	{
		...
		public BabylonVector3 MaxVector = new BabylonVector3 { X = float.MinValue, Y = float.MinValue, Z = float.MinValue};
		public BabylonVector3 MinVector = new BabylonVector3 { X = float.MaxValue, Y = float.MaxValue, Z = float.MaxValue};
