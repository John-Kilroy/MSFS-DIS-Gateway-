...
namespace MSFS2024_Max2Babylon
{
    public partial class BabylonExporter
    {
        ...
        public Dictionary<string, object> ExportExtraAttributes(IIGameMaterial gameMaterial, BabylonScene babylonScene, List<string> excludeAttributes = null)
        {
            ...
            return ExportExtraAttributes(gameMaterial.IPropertyContainer, babylonScene, excludeAttributes);
        }
        ...
        public Dictionary<string, object> ExportExtraAttributes(IIGameNode gameNode, BabylonScene babylonScene, List<string> excludeAttributes = null)
        {
            ...
            return ExportExtraAttributes(gameNode.IGameObject.IPropertyContainer, babylonScene, excludeAttributes);
        }
        ...
        /// <param name="babylonScene"></param>
        /// <param name="excludeAttributes">Attribute names to not export</param>
        private Dictionary<string, object> ExportExtraAttributes(IIPropertyContainer propertyContainer, BabylonScene babylonScene, List<string> excludeAttributes = null)
        {
               ...
               logger?.RaiseMessage(entry.Key + "=" + entry.Value, 2);
                ...
                switch (entry.Value.ToLowerInvariant())
                {
                    ...
                    case "material":
                        ...
                        break;
                    default:
                        logger?.RaiseWarning("[BABYLON][WARNING] Unknown type '" + entry.Value + "' for custom attribute named '" + entry.Key + "'", 2);
                        break;
                }
