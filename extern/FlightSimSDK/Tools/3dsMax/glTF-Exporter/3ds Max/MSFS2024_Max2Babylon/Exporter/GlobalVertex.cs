...
namespace MSFS2024_Max2Babylon
{
    public struct GlobalVertex
    {
        ...
        public GlobalVertex(GlobalVertex other)
        {
            ...
            this.Tangent = other.Tangent?.Clone2();
            this.UV = other.UV?.Clone();
            this.UV2 = other.UV2?.Clone();
            this.BonesIndices = other.BonesIndices;
            this.Weights = other.Weights?.Clone();
            this.BonesIndicesExtra = other.BonesIndicesExtra;
            this.WeightsExtra = other.WeightsExtra?.Clone();
            this.Color = other.Color?.Clone2();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            GlobalVertex other = (GlobalVertex)obj;
