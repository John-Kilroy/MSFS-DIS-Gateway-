    ...
    public partial class BabylonExporter
    {
        ...
        private BabylonNode ExportLight(IIGameScene scene, IIGameNode lightNode, BabylonScene babylonScene)
        {
           ...
           logger?.RaiseMessage(lightNode.Name, 1);
            ...
            // Type
            ILightObject maxLight = (lightNode.MaxNode.ObjectRef as ILightObject);
            ILightState lightState = Loader.Global.LightState.Create();
            ...
            //    else
            //    {
            //        logger?.RaiseWarning("[BABYLON][WARNING][Lights] Shadows maps are only supported for point, directional and spot lights", 2);
            //    }
            //}
