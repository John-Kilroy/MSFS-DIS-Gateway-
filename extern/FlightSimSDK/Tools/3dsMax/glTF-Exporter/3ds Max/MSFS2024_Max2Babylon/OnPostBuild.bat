...
:OnRelease
SET dest_dir="%~dp0\..\..\..\..\..\..\ASSETS\KittyHawk_Data\Tools\3DSMAX\MSFS2024Package\src\plugins\glTF_Exporter\%max_version%"
GOTO CopyFiles
...
if exist %dest_dir%\MSFS2024_Max2Babylon.dll del /f /q %dest_dir%\MSFS2024_Max2Babylon.dll
COPY %source_dir%\MSFS2024_Max2Babylon.dll %dest_dir%\MSFS2024_Max2Babylon.dll

if exist %dest_dir%\MSFS2024_Max2Babylon.dll.config del /f /q %dest_dir%\MSFS2024_Max2Babylon.dll.config
COPY %source_dir%\MSFS2024_Max2Babylon.dll.config %dest_dir%\MSFS2024_Max2Babylon.dll.config
