...
namespace MSFS2024_Max2Babylon
{
    static class LayerUtilities
    {
        ...
        public static IINodeTab GetNodeTabLayersChildren(IList<IILayer> exportedLayers)
        {
            if (exportedLayers == null) return null;
        ...
        public static void DeleteSceneLayer(string layerName)
        {
            ScriptsUtilities.ExecuteMaxScriptCommand($@"MSFS2024_Functions.deleteLayer name:""{layerName}"""); // You can find this function in MSFS2024_Functions.ms
        }
    }
}
